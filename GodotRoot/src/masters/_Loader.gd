...
#onready var res_lib_helper = load("res://src/actors/action_libraries/ALib1_Helper.gd")
#onready var res_lib_general = load("res://src/actors/action_libraries/ALib2_General.gd")
#onready var res_lib_player = load("res://src/actors/action_libraries/ALib3_Player.gd")
#onready var res_lib_enemy = load("res://src/actors/action_libraries/ALib4_Enemy.gd")
