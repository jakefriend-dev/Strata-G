...
var tags: Dictionary = {
	...
	"travel": {
		"display_name": "Travel",
		"type": "Mechanic",
		"display_desc": "Linear ground-based movement from one adjacent tile to another. Standard 'walking' movement is travel, but jumping/teleporting are not. Travel incurs things like [ice] tile slipperiness, while teleporting on to an ice tile would not.",
		"subtags": ["ice_tile"],
	},
	"fracture": {
		"display_name": "AP Fracture",
		"type": "Mechanic",
		"display_desc": "Some minor actions/penalties cause Action Point crystals to receive a fracture line, but not immediately break (ie. AP is not expended). AP crystals can be fractured twice safely, but on their 3rd fracture, break and are expended. This makes some minor actions, such as standard unit 'walking' movement, 'free' or very low-cost. [Elec] damage always causes AP fracture.",
		"subtags": ["elec"],
	},
#	"example": {
...
#	},
	...
	"hovering": {
		"display_name": "Hovering",
		"type": "Unit property",
		"display_desc": "Units that are hovering are not affected at all by tile types, nor take [ground] attack damage/effects.",
		"subtags": ["ground"],
	},
	"lightweight": {
	...
	"heavy": {
		"display_name": "Heavy",
		"type": "Unit property",
		"display_desc": "Units that cannot be easily moved by others. Notably, a heavy unit on an [ice] tile behaves like a standard non-heavy unit.",
		"subtags": ["ice_tile"],
	},
#	"example": {
#		"display_name": "ffffffffffffffffff",
...
#	},
	...
	# MISC UNIT IMMUNITIES/PROPERTIES
	
	"woodland": {
		"display_name": "Woodland",
		"type": "Unit property",
		"display_desc": "Woodland units bypass the AP cost entry penalty of [overgrowth] tiles, but still receive the benefits.",
		"subtags": [],
	},
	"smasher": {
		"display_name": "Smasher",
		"type": "Unit property",
		"display_desc": "Units of immense physical force; their attacks are always [bludgeoning]. Smashers also treat [jagged] tiles as standard, neither being penalized nor resetting it.",
		"subtags": ["bludgeon", "jagged"],
	},
#	"example": {
#		"display_name": "ffffffffffffffffff",
#		"type": "Unit property",
...
#	},
	...
	"knockback": {
		...
		"type": "Mechanic",
		"display_desc": "A type of movement which causes damage when it cannot be completed. If a unit would be shoved 2 tiles away but a rock is in the way, the 2 tiles of motion are received as 2 damage. Not all externally-caused movement is knockback; usually knockback is only applied if the movement is violent or abrupt.",
		"subtags": [],
	},
#	"example": {
#		"type": "Mechanic",
...
#	},
	...
	"wilder": {
		"display_name": "Wilder",
		"type": "Damage element",
		"display_desc": "Wild damage always turns any impacted tiles into [overgrowth].",
		"subtags": ["overgrowth_tile"],
	},
	"water": {
		"display_name": "Water",
		"type": "Damage element",
		"display_desc": "Water moves will always break 1/4 of a [shield] on impact, even when dealing 0 damage. Cools & erases [ember] tiles.",
		"subtags": ["shield", "ember_tile"],
	},
	"ice": {
		"display_name": "Ice",
		"type": "Damage element",
		"display_desc": "Ice attacks always cause the [Frigid] status to impacted units. If an ice attack hits an [ember] tile, it will convert the tile to [puddle].",
		"subtags": ["shield", "ember_tile", "puddle_tile"],
	},
	"fire": {
		"display_name": "Fire",
		"type": "Damage element",
		"display_desc": "Fire damage is always [piercing]. Fire also does 1 extra damage to units on [overgrowth] tiles and resets the tile to standard, or converts [ice] tiles to [puddles].",
		"subtags": ["piercing", "overgrowth_tile", "puddle_tile"],
	},
	"poison": {
		"display_name": "Poison",
		"type": "Damage element",
		"display_desc": "Poison attacks always caused the [Poisoned] status to impacted units.",
		"subtags": ["status_poisoned"],
	},
	"ground": {
		"display_name": "Ground",
		"type": "Damage element",
		"display_desc": "Does not affect [hovering] units; typically also ignores cover.",
		"subtags": ["hovering"],
	},
	"elec": {
		"display_name": "Elec",
		"type": "Damage element",
		"display_desc": "Always turns the tile below the impacted unit to [static]. If the unit was on a [puddle] tile, does +1 damage to them first.",
		"subtags": ["static_tile", "puddle_tile"],
	},
	"bleed": {
		"display_name": "Bleed",
		"type": "Damage element",
		"display_desc": "Bleed damage turns the tile below the impacted unit to [blood].",
		"subtags": ["blood_tile"],
	},
	"bludgeon": {
		"display_name": "Bludgeon",
		"type": "Damage element",
		"display_desc": "Bludgeon damage always expends 1 AP of the impacted unit.",
		"subtags": [],
	},
#	"example": {
#		"display_name": "ffffffffffffffffff",
...
#	},
	...
	"magic_tile": {
		...
		"type": "Tile type",
		"display_desc": "Enchanted tiles can never be altered into a different tile type.",
		"subtags": [],
	},
	"jagged_tile": {
		"display_name": "Jagged",
		"type": "Tile type",
		"display_desc": "Jagged tiles deal 1 damage and penalize 1 AP upon a unit entering them, after which they revert to a standard tile.",
		"subtags": [],
	},
	"overgrowth_tile": {
	...
	"ember_tile": {
		"display_name": "Ember",
		"type": "Tile type",
		"display_desc": "Ending your turn on an ember tile incurs 1 [fire] damage, but *starting* your turn on an ember tile confers +1 AP.",
		"subtags": ["fire"],
	},
	"poison_tile": {
		"display_name": "Poison",
		"type": "Tile type",
		"display_desc": "Both entering and [resting] on a poison tile causes 1/4 [shield-bypassing] damage.",
		"subtags": ["shield_bypass"],
	},
	"ice_tile": {
		"display_name": "Ice",
		"type": "Tile type",
		"display_desc": "Slippery; any unit that ends an action/movement on an ice tile via [travel] will slide to the far side of it, if possible. [Lightweight] units are too light to be affected.",
		"subtags": ["travel", "lightweight"],
	},
	"puddle_tile": {
		"display_name": "Puddle",
		"type": "Tile type",
		"display_desc": "Puddle tiles will break 1/4 [shield] each time a unit [rests] on it. Units in puddles also receive +1 damage from [elec] attacks.",
		"subtags": ["resting", "shield", "elec"],
	},
	"static_tile": {
		"display_name": "Static",
		"type": "Tile type",
		"display_desc": "Static tiles lock the joints of units on them; they must 'rest' to reset the tile to a standard one, and cannot move or use actions involving movement until they have done so.",
		"subtags": [],
	},
	"blood_tile": {
		"display_name": "Blood",
		"type": "Tile type",
		"display_desc": "On its own, a blood tile has no effect; however, certain powerful moves require blood tiles to be usable. Typically, any unit capable of dealing [bleed] damage has moves taking advantage of blood tiles.",
		"subtags": ["bleed"],
	},
	"wind_tunnel_tile": {
		"display_name": "Wind Tunnel",
		"type": "Tile type",
		"display_desc": "When standard-weight units [rest] in a wind tunnel, they are moved off of it in a specific, fixed direction. [Heavy] units are unaffected, while [lightweight] units are moved immediately upon entering the tile.",
		"subtags": ["resting", "heavy", "lightweight"],
	},
	"lodestone_tile": {
		"display_name": "Lodestone",
		"type": "Tile type",
		"display_desc": "When a unit is [rests] next to an unoccupied lodestone tile, it is pulled onto it. This effect is resisted if the unit is next to multiple lodestones at once, or already on a lodestone.",
		"subtags": ["resting"],
	},
#	"example": {
#		"display_name": "ffffffffffffffffff",
